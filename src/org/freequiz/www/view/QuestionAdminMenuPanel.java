...
//	private JList questionsList;
	...
	private FQDefaultComboBoxModel topicFilterDataModel;
	private FQDefaultComboBoxModel subjectFilterDataModel;
//	private FQDefaultComboBoxModel gradeLevelFilterDataModel;
...
//		gradeLevelFilterDataModel = new FQDefaultComboBoxModel(defaultGradeLevelFilterList);
...
//		searchFilterButton.addActionListener(new ActionListener() {
...
//		questionsListDataModel = new FQDefaultListModel(defaultQuestionsList);		
		...
		questionsListTable = new JTable(rowData, columnNames);
//		questionsListTable = new JTable();
		...
		questionsListTable.getColumn("Grade Level").setCellRenderer(dtcr);
...
//		});
		...
		layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addComponent(filterPanel, GroupLayout.PREFERRED_SIZE, 730, Short.MAX_VALUE)
				.addComponent(questionsPanel, GroupLayout.PREFERRED_SIZE, 730, Short.MAX_VALUE)
